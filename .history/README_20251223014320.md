...
- The data should be given in the format of a csv, much like the exemplary DN.csv found in that folder.(a column with a name of the chemical and a column named after the property with the property values (names of columns should have no spaces ideally))
