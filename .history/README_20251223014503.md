...
- Navigate into the data_creation_pipeline folder. Install the requirements.txt of that folder using `pip install -r requirements.txt` from the terminal on the folder level that the requirements.txt is.
